...
namespace Online_Shop
{
    public class Product
    {
        ...
        public void GetProduct()
        {
            ...
            Storage.Products.Add(new Product { ID = 4, Name = "Смартфон Apple iPhone 12 Pro 128GB RU", Price = 3899.99, Quantity = 62, Description = "" });
            Storage.Products.Add(new Product { ID = 5, Name = "Смартфон Apple iPhone 12 64GB, красный", Price = 2544.99, Quantity = 32, Description = "" });
            Storage.Products.Add(new Product { ID = 6, Name = "Смартфон Apple iPhone 13 Pro Max 128 ГБ", Price = 4250.99, Quantity = 12, Description = "" });
            Storage.Products.Add(new Product { ID = 7, Name = "Стиральная машина с сушкой LG F2V5NG0W", Price = 1343.99, Quantity = 22, Description = "" });
            Storage.Products.Add(new Product { ID = 8, Name = "Стиральная машина с сушкой Weissgauff WMD 4748 DC", Price = 1599.99, Quantity = 37, Description = "" });
            Storage.Products.Add(new Product { ID = 9, Name = "Стиральная машина с сушкой Samsung WD70T4047CE/LP", Price = 1543.99, Quantity = 46, Description = "" });
            ...
            Storage.Products.Add(new Product { ID = 11, Name = "Видеокарта GIGABYTE GeForce RTX 3060 GAMING OC 12G", Price = 3100, Quantity = 15, Description = "" });
            ...
            Storage.Products.Add(new Product { ID = 16, Name = "Умные часы Apple Watch Series 6 GPS 40мм", Price = 999.99, Quantity = 68, Description = "" });
